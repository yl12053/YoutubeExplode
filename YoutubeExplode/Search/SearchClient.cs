...
public class SearchClient(HttpClient http)
{
    ...
    /// </summary>
    public IUniTaskAsyncEnumerable<Batch<ISearchResult>> GetResultBatchesAsync(
        string searchQuery,
        SearchFilter searchFilter,
        CancellationToken cancellationToken1 = default
    )
    {
        return UniTaskAsyncEnumerable.Create<Batch<ISearchResult>>(async (writer, cancellationToken) =>
        {
            ...
            do
            {
                ...
                await writer.YieldAsync(Batch.Create(results));
    ...
    /// </summary>
    public IUniTaskAsyncEnumerable<ISearchResult> GetResultsAsync(
        string searchQuery,
        CancellationToken cancellationToken = default
